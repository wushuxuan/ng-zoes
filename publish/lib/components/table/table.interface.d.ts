...
export interface STColumn {
     ...
     */
    click?: (record: STData, instance?: TableComponent) => any;
    /**
     * 按钮组
     */
...
export interface STColumnButton {
     ...
     */
    click?: 'reload' | 'load' | ((record: STData, modal?: any, instance?: TableComponent) => any);
    /**
...
export interface STColumnButtonModal {
    /**
     * 对话框组件对象
     */
    component?: any;
...
export interface STColumnButtonDrawer {
    /**
     * 标题
     */
    title?: string;
